...
const COLOR_DIFF_THRESHOLD = 2; // The lower this is the closer to the target colour the pixel must be (black currently)
const SAMPLING_ACCURACY = 10; // Number of pixels between each sample taken from image to check colour.
